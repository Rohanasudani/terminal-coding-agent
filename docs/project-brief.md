...
- Built a benchmarkable terminal coding agent in Python with structured repo search, file read/write tools, shell execution, approval gates, diff previews, JSONL traces, and safe live-model integration.
